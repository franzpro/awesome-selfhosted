...
- [Peppermint](https://peppermint.sh/) - A central hub for your help desk. A powerfully easy system for tracking, prioritising, and solving customer support tickets. ([Source Code]https://github.com/Peppermint-Lab/peppermint)) `AGPL-3.0`
